...
| Backend API | In progress | `GET /api/skills`, `GET /api/skills/:name`, `GET /api/bundles`, and `GET /api/agents` done; remaining endpoints pending |
...
1. Implement remaining API endpoints (`api-health`, `api-store`)
